...
function updateRemoteApp() {
  return ssh.execCommand(
    `cp -r ${dir}/* starter-node-angular/ && rm -rf starter-node-angular-temp`, {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    `cd ${dir} && sudo service mongod start && pm2 start app.js`, {
      cwd: '/home/ubuntu'
  });
}
